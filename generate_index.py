...
def parse_readme(file_path):
    ...
    for match in story_pattern.finditer(content):
        ...
        if t_a_1 and l_1:
            ...
            rabibasariya.append({
                'title': t.replace(':crown: ', '').replace(':crown:', ''), 
                'author': a, 
                'link': html_link,
                'md_path': md_path
            })
    ...
    for story in stories:
        ...
        if os.path.exists(md_file):
            ...
            final_html = story_template.format(
                title=story['title'].replace(':crown: ', '').replace(':crown:', ''),
                author=story['author'],
...
<head>
    ...
    <style>
        ...
        * {
        ...
        .book:nth-child(5n+1) { background: #8b4513; color: #fdfbf7; } /* Saddle Brown */
        .book:nth-child(5n+2) { background: #556b2f; color: #fdfbf7; } /* Dark Olive Green */
        .book:nth-child(5n+3) { background: #800000; color: #fdfbf7; } /* Maroon */
        .book:nth-child(5n+4) { background: #2f4f4f; color: #fdfbf7; } /* Dark Slate Gray */
        .book:nth-child(5n+5) { background: #b8860b; color: #fdfbf7; } /* Dark Goldenrod */
            ...
            currentItems.forEach(story => {
                const bookHtml = `
                    <a href="${story.link}" class="book" target="_self">
                        ...
                        <div class="book-title">${story.title.replace(/:crown:\s?/, "")}</div>
