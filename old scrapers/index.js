    ...
    if (error) {
      ...
      $('div[class="thumb-row section mb-4"]').each((index, element) => {
        const article_link =
          ...
          $(element)
            .find('a[class = "d-flex text-decoration-none link-reset mb-4"]')
            .attr("href")
            .trim();
...
// TODO: classes, IDs are getting modified frequently by developers, need
// another approach to look for the targets while crawling.

// TODO: some of the stories name are gerbage, clean them
// TODO: write more clean code, refactoring needed!
// TODO: need documentation for future development, specify the steps to build
// and run
